...
```shell
dockermgr download src jellyfin
```

OR

```shell
git clone "https://github.com/casjaysdevdocker/jellyfin" "$HOME/Projects/github/casjaysdevdocker/jellyfin"
```

## Build container  

```shell
cd "$HOME/Projects/github/casjaysdevdocker/jellyfin"
buildx 
```
