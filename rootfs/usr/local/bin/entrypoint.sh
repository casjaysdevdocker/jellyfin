...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211132223-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  entrypoint.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 13, 2022 22:23 EST
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for jellyfin
...
__heath_check() {
  ...
  start-jellyfin.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-jellyfin}"
